...
class Steps_Dance_Academy_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function steps_dance_academy_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function steps_dance_academy_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function steps_dance_academy_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function steps_dance_academy_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->steps_dance_academy_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function steps_dance_academy_load( $class ) {
