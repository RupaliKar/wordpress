...
class Steps_Dance_Academy_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function steps_dance_academy_loadClassLoader($class)
    {
    ...
    public static function steps_dance_academy_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
